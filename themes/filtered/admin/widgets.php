...
register_sidebar(array(
	...
	'before_widget' => '<div id="%1$s" class="oneThird %2$s sidebarBox widgetBox">',
	'after_widget' => '</div>',
	'before_title' => '<h3>',
	'after_title' => '</h3>'
));
...
?>		
		...
		<?php if($show_post == "true") :?>
			...
			<?php $ttrust_feed = $rp_cat ? get_category_feed_link($rp_cat, '') : ttrust_get_option('ttrust_rss'); ?>
...
class TTrust_Twitter extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        $user	= empty($instance['user']) ? ttrust_get_option('ttrust_twitter') : $instance['user'];        
...
class TTrust_Flickr extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        $user	= empty($instance['user']) ? ttrust_get_option('ttrust_flickr') : $instance['user'];
...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('user'); ?>"><?php _e('User:', 'themetrust'); ?>
			<input class="widefat" id="<?php echo $this->get_field_id('user'); ?>" name="<?php echo $this->get_field_name('user'); ?>" type="text" value="<?php echo esc_attr($user); ?>" />
			</label>
		</p>
