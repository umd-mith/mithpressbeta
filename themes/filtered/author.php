			    ...
			    <div class="post clearfix <?php echo $postClass; ?>">
					...
					<div class="inside">					
						...
						<div class="meta clearfix">						
							<?php _e('Posted on', 'themetrust'); ?> <?php the_time( 'M j, Y' ) ?> <?php _e('in', 'themetrust'); ?> <?php the_category(', ') ?> | <a href="<?php comments_link(); ?>"><?php comments_number(__('No Comments', 'themetrust'), __('One Comment', 'themetrust'), __('% Comments', 'themetrust')); ?></a>
						</div>																	
						<?php the_excerpt(); ?>
						<?php more_link(); ?>						
					</div>																				
